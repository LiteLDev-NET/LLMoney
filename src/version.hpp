...
// underscore(_).
#define PLUGIN_NAME "LLMoney.NET"
// Describe what your plugin does
// We recommend you start the introduction with a third-person singular verb.
#define PLUGIN_INTRODUCTION "LLMoney bindings for .NET"
#define PLUGIN_AUTHOR "LiteLDev.NET"
...
#define PLUGIN_ASSEMBLY_VERSION  TO_VERSION_STRING(PLUGIN_VERSION_MAJOR.PLUGIN_VERSION_MINOR.PLUGIN_VERSION_REVISION.*)

#define PLUGIN_ASSEMBLY_FILE_VERSION  TO_VERSION_STRING(PLUGIN_VERSION_MAJOR.PLUGIN_VERSION_MINOR.PLUGIN_VERSION_REVISION.PLUGIN_VERSION_BUILD)
